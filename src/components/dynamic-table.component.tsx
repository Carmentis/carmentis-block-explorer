...
function DynamicRow<T>({numberOfCols, row, index, renderRow, noWrap}: {
    ...
    if (error) {
        return (
            <td colSpan={numberOfCols} className="px-6 py-6 text-center">
                <div className="bg-red-50 border border-red-200 rounded-lg p-4 flex flex-col md:flex-row items-center justify-center text-red-600 transition-all duration-300 hover:bg-red-100 shadow-sm mx-auto max-w-2xl">
